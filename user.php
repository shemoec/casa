<?php
    class User extends Base{
        ...
        public function getUserContribution($userId) {
            $stmt = $this->pdo->prepare("SELECT SUM(Amount) as total_contribution FROM contributions WHERE UserId = :user_id");
            $stmt->bindParam(":user_id", $userId, PDO::PARAM_INT);
            $stmt->execute();
            $data = $stmt->fetch(PDO::FETCH_ASSOC);
        
            if ($data && isset($data['total_contribution']) && $data['total_contribution'] !== NULL) {
